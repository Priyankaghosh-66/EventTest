...
(function($) {
    ...
    */
	...
	ImagesGridModal.prototype.renderDetails = function() {
        this.$details = $('<div>', {
            class: 'modal-details',
            text: this.getImagedetails(this.imageIndex)
        }).appendTo(this.$modal);
    };
    ...
    ImagesGridModal.prototype.updateImage = function() {
        ...
        this.$modal.find('.modal-caption').text(
			...
			this.$modal.find('.modal-details').text(
            this.getImagedetails(this.imageIndex) );
	...
	ImagesGridModal.prototype.getImagedetails = function(imgIndex) {
        var img = this.getImage(imgIndex);
        return img.details || '';
    };
