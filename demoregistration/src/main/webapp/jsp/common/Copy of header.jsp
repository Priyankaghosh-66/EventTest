...
<!-- <link href="/ET/css/new/component.css" rel="stylesheet" type="text/css" /> -->
...
<script>jwplayer.key="P3e7JyGsBqNF7QFxyqDb9Ht9efxl0/yPXyu81A==";</script>
...
<!-- For Production, use: -->
  <!--   <script type="text/javascript" src="http://js.authorize.net/v1/Accept.js" charset="utf-8"></script> -->
...
<!-- show upgrade user popup start -->
			...
			<div class="modal-dialog" style=" width: 809px; margin: 30px auto;">
				...
				<div class="modal-content" style="height: 90%;">
					...
					<div class="modal-body modal-border">
						<div id="showUpgradeUserMessageContent">
							<form:form
								action="userUpgradationSuccessful?${_csrf.parameterName}=${_csrf.token}" modelAttribute="upgradeUser"
								method="post" id="upgradUserFormId">
								
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="upload-box">
										<label style="margin-top: 43px;margin-left: 125px;"><span class="field-name membership" >Please choose your membership type from below.</span></label>
			...
			<div class="col-sm-8" id="UpgradePage">


					<div class="form-group">
						<label> <span class="field-name">Card Number:</span></label>
				    	<input type="tel" id="cardNumberID" name="cardNumberID" placeholder="5424000000000015" autocomplete="off" value="" maxlength="20" />
				    </div>
			
				  
				   <div class="form-group ">
						<label> <span class="field-name">Expiration Month(MM):</span></label>
					    <input type="text" id="monthID" name="monthID" placeholder="12" value=""  maxlength="2"/></div>
				  
				    <div class="form-group ">
						<label> <span class="field-name">Expiration Year(YYYY):</span></label>
					    <input type="text" id="yearID" name="yearID" placeholder="2025" value=""  maxlength="4"/>
				    </div>
				   
				    <div class="form-group ">
						<label> <span class="field-name"> CVV:</span></label>
					    <input type="text" id="cardCodeID" name="cardCodeID" placeholder="123" maxlength="3"/>
				    </div>
										...
										<div class="col-sm-6">
											...
											<div class="btn-wrapp">
											<button type="button" class="btn btn-default btn-custom" style="  width: 305px;" id="payment" >Payment using authorize.net  &nbsp;<i class="fa fa-long-arrow-right" aria-hidden="true"></i></button>
											</div>
										</div>
								...
								<div class="user-pic">
									...
									<div id="panel" class="panel-div">
										...
										<div class="btm-area">
											...
											<%-- <c:if test="${parent_email_id != null}">
											 <div class="action-area">
												<a href="/ET/user/j_spring_security_switch_user?j_username=${parent_email_id}" class="btn blue-button"> 
