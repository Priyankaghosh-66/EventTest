...
<script type="text/javascript" src="/ET/js/jquery-1.11.1.min.js"></script>
...
<script type="text/javascript" src="/ET/js/moment.min.js"></script> 
<script type="text/javascript" src="/ET/js/bootstrap-datepicker.min.js"></script>
 
<link href="/ET/css/datepicker.min.css" rel="stylesheet" type="text/css"/>
  ...
  <section class="black-header-signup">
    <div class="container-fluid-signup">
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <div class="logo-area-signup"> <a href="#"><img src="/ET/images/logo.png" alt="logo"></a> </div>
      </div>
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <div class="right-panel">
          <form:form action="/ET/user/j_spring_security_check?${_csrf.parameterName}=${_csrf.token}"
...
<section class="index-area">
 ...
 <div class="login-white-form1">
<form:form action="/ET/register?${_csrf.parameterName}=${_csrf.token}" method="post" modelAttribute="userReg" id="regForm"   >
...
<div class="form-group">
  ...
  <div class="form-group">
   <form:input path="mobileno" type="text" name="mobileno" value=""  placeholder="Mobile number" class="form-control inp ploaceholderinp" /> 
   </div>
   <div class="form-group">
  ...
  <div class="form-group">
        ...
        <div class="date">
            <div class="input-group input-append date" id="datetimepicker">
                <form:input path="bday" class="form-control" type="text" placeholder="Birthday" name="bday"  value="" style="background: white;" readonly="true" />
 ...
 src="/ET/images/index_image1.jpg" 
...
<p class="font_8">&nbsp;</p></div>
 ...
 <img id="WPht4-h3gimgimage" alt="" data-type="image" src="/ET/images/index_image3.jpg" style="width: 480px; height: 321px; object-fit: contain;"></div></div></div>
