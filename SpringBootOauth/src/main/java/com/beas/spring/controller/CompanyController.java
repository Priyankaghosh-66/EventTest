package com.beas.spring.controller;
...
import com.beas.spring.service.CompanyService;
...
public class CompanyController {
	 ...
	 @Autowired
	    ...
	    public ResponseEntity<?> create(@RequestBody Company company) {
	        ...
	        ControllerLinkBuilder linkBuilder = linkTo(methodOn(CompanyController.class));
